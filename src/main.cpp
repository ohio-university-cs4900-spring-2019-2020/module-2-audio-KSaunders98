...
#include <vector>
#include <memory>
#include "GLViewSoundTestModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewSoundTestModule > glView( Aftr::GLViewSoundTestModule::New( args ) );
